...
Des weiteren wird an die Daten aus Tabelle \ref{Gauß1} eine Gauß-Funktion
...
\input{"Tabellen/Untergrund.tex"}

\input{"Tabellen/Gauss1.tex"}
...
\input{"Tabellen/Diskussion1.tex"}
