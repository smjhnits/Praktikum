...
print('Vergleich mit 3R')
print('Graphit: ', np.mean(graphit) / (c_V_Vergleich) * 100)
print('Blei2: ', np.mean(blei2) / (c_V_Vergleich) * 100)
print('Kupfer: ', np.mean(kupfer) / (c_V_Vergleich) * 100)
print('3R: ', c_V_Vergleich, np.mean(graphit) * 12)
