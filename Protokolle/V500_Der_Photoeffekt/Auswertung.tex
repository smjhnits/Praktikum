...
\ref{tab:GelbKomplett} lediglich die Werte für $U$ $\geq \SI{0}{\volt}$ betrachtet und in
...
\input{"Tabellen/Spannungen_Tabellen.tex"}
...
\input{"Tabellen/Tabelle_Gruen.tex"}
...
\input{"Tabellen/Tabelle_Blau_Gruen.tex"}
...
\input{"Tabellen/Tabelle_Blau.tex"}
...
\input{"Tabellen/Tabelle_UV1.tex"}
...
\input{"Tabellen/Tabelle_UV2.tex"}
...
\input{"Tabellen/Messparameter.tex"}
...
Spektralfarben (siehe Tab. \ref{tab:Spannungen}) lassen sich die gesuchten
Parameter
...
\input{Tabellen/Tabelle_Gelb_Komplett.tex}
...
Die verwendeten Werte sind in die obige Tabelle \ref{tab:Gelb} eingetragen.
