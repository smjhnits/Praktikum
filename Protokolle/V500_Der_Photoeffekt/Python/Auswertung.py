...
#print("Gelb: ", np.sqrt(Spektral_gelb_komplett), '\n')
#print("Grün: ", np.sqrt(Spektral_grün), '\n')
#print("Blau-Grün: ", np.sqrt(Spektral_blau_grün), '\n')
#print("Blau: ", np.sqrt(Spektral_blau), '\n')
#print("UV1: ", np.sqrt(Spektral_UV1), '\n')
#print("UV2: ", np.sqrt(Spektral_UV2), '\n')
...
U_g = np.array([x_gelb, x_grün, x_b_g, x_blau, x_UV1, x_UV2])
