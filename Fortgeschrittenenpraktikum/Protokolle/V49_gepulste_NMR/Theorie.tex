...
\begin{equation}
  ...
  \braket{\text{\textbf{I}}\ua{z}} = \frac{\sum^\text{\textbf{I}}_{m = -\text{\textbf{I}}}
  \hbar m \exp{\left(-m\beta(T)\gamma B_0 \hbar\right)}}{\sum^\text{\textbf{I}}_{m = -\text{\textbf{I}}}
...
\begin{figure}
  \centeing
  \includegraphics[width = \textwidth]{Pics/aufspaltungE}
...
\begin{equation}
  \label{eqn:mag_diff}
  \frac{\su{d}\vec{M}}{\su{d}t} = \gamma\vec{M}\timesB_0\vec{e}_z
\end{equation}
...
\begin{description}
  \item[Spin-Gitter-Relaxationszeit/longitudinal:]Relaxationszeit parallel zur Magnetfeldrichtung.
  Charakteristische Übergangszeit von Energie des Kernspins in Gitterschwingungen und umgekehrt.
  \item[Spin-Spin-Relaxationszeit/transversal:]Relaxationszeit senkrecht zur Magnetfeldrichtung.
