...
$\num{5.9}\,\%$ kleiner als der Theoriewert $\theta\ua{D}$.
Diese Abweichung kann durch eine ungleiche Wärmeabstrahlung von Probe und Zylinder
erklärt werden, welche darauf beruhen könnte, dass beispielsweise das Kupfer
des Zlinders eine dickere Oxiedschicht besitzt. Damit wäre die Emissivität ungleich
