...
angezeigt. Zur Minimierung von Hintegrundrauschen wird zusätzlich ein Selektivverstärker
zwischengeschaltet. Dieser wird auf die selbe Frequenz wie der Lichtzerhacker
eingestellt, so dass nur mit dieser Frequenz modulierte Signale gemessen werden.
