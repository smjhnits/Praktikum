...
Zudem sollten die Landé-Faktoren der Übergänge sowie die Energiedifferenz mithilfe
von Formel \eqref{eqn:EdiffZeemanNormal} und \eqref{eqn:LandeNormal} berechnet werden
(Tabelle \ref{tab:LandeRot})

\begin{figure}
  \centering
  \includegraphics[width=10cm]{Pics/termschema_rot.pdf}
