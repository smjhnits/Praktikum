...
plt.clf()
plt.plot(theta, dispersion_C / 1000, 'b-', label=r'Dispersionskurve C')
plt.plot(theta, grenzfrequenz_theo_C / 1000, 'b--')
plt.plot(x_Werte_Disperion_1, omega_C_Dispersion / 1000, 'bx', label=r'Messdaten')
plt.ylabel(r'$\omega$ in $1/ms$')
plt.xlabel(r'$\theta$')
...
plt.clf()
plt.plot(theta, dispersion_C1C2_1 / 1000, 'b-', label=r'optischer Ast')
plt.plot(theta, dispersion_C1C2_2 / 1000, 'r-', label=r'akkustischer Ast')
plt.plot(x_Werte_Disperion_2, omega_C1C2_Dispersion / 1000, 'gx', label=r'Messdaten')
plt.plot(theta, grenzfrequenz_theo_C1C2_2 / 1000, 'r--')
plt.plot(theta, grenzfrequenz_theo_C1C2_1 / 1000, 'b--')
plt.ylabel(r'$\omega$ in $1/ms$')
plt.xlabel(r'$\theta$')
...
plt.clf()
plt.plot(omega_theo / (2 * np.pi) / 1000, v_Ph_theo / 1000, 'b-', label=r'$v_{Ph}(\nu)$')
plt.plot(omega / (2 * np.pi) / 1000, v_Ph / 1000, 'rx', label=r'Messdaten')
plt.xlabel(r'$\nu$ in $kHz$')
plt.ylabel(r'Phasengeschwindigkeit in $\frac{1}{ms}$')
plt.xlim(0, 50)
plt.legend(loc='best')
plt.tight_layout()
